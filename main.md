                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Row(
                                              ...
                                              crossAxisAlignment: CrossAxisAlignment.center,
                                              children: <Widget>[
                                                Text('05:20 pm : เบี่ยงจราจร ถนนรามอินทรา ขาเข้า'),
                                              ],
                                            ),
                                            Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                              crossAxisAlignment: CrossAxisAlignment.center,
                                              children: <Widget>[
                                                Text('06:19 pm : เบี่ยงจราจร ถนนรามอินทรา ขาออก'),
                                              ],
                                            ),
                                            Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                              crossAxisAlignment: CrossAxisAlignment.center,
                                              children: <Widget>[
                                                Text('07:18 am : รถเสีย ถนนเทพรัตน'),
                                              ],
                                            ),
                                            Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                              ...
                                              children: <Widget>[
                                                TextButton(
                                                  ...
                                                  child: Text('View more on ITIC website >>', style: TextStyle(color: Colors.indigo, decoration:TextDecoration.underline,)),
                                                ),
                                              ],
                                            ),
                                            Row(
                    ...
                    void _launchURL() async =>
                        await canLaunch('https://www.iticfoundation.org/home') ? await launch('https://www.iticfoundation.org/home') : throw 'Could not launch URL:  https://www.iticfoundation.org/home';
